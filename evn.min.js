...
attr[1]+'">');e+="<section "+attrHtml+">";e+=j;e+=content[1];e+="</section>"}$itemContent.append(e);$view.waitForImages(function(){$body.removeClass("loading").addClass("view-item-mode");iRefresh()})}).error(function(){setTitle("Nothing");$itemName.html("");$itemDate.html("");$itemContent.html('<section class="text">Not available right now</section>');$body.removeClass("loading").addClass("view-item-mode")})):$body.addClass("view-item-mode")}
function closeItem(){$body.removeClass("view-item-mode slideup");view=INDEX;history.pushState({},"","/");setTitle("Portfolio")}function isTouchDevice(){var b=document.createElement("div");b.setAttribute("ongesturestart","return;");return"function"===typeof b.ongesturestart}function iRefresh(){IS_TOUCH&&setTimeout(function(){myScroll.refresh()},0)}
